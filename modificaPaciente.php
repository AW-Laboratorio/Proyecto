	...
	<div class="contenedor">
        ...
        <div class = "alinearContenido">
          <div class = "datosP">
            ...
            <div>
              <form action="includes/Formularios/formModificaEmail.php" method="post">
                ...
                <label for="Email" class="align">Nuevo correo :</label>
                  ...
                  <input type="text" id="dni" name="dni" value="<?php echo $dni;?>" hidden/><button class="modif_datos">Modificar</button>
                  </fieldset>
              </form>
            </div>
            </div>
            ...
            <div class = "modifica">
            <div>
              <form  action="includes/Formularios/formModificaPassP.php" method="post">
                <fieldset>
